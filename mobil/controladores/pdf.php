...
$html = '<table align=center  border="0" width="600">
					<tr>
						<td align=center colspan=2>
							<h3>INFORME M&Eacute;DICO</h3>
						</td>
					</tr>
					<tr>
						<td colspan=2 nowrap>
						 Se Trata a <strong>'.$nombre.'</strong>  de n&uacute;mero de c&eacute;dula de  
					...
					<tr>
						<td colspan=2 nowrap>
							<strong> Se diagn&oacute;stico </strong>
							<label>'.$dig.'</label>
						</td>
					</tr>
					<tr>
						<td colspan=2 nowrap>
							<strong>Se indica como tratamiento </strong>
							<label>'.$trata.'</label>
						</td>
					</tr>
			</table>';
